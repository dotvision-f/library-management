...
class Build:
    def __init__(self):
        ...
        self.Member_DB.add_member('20010737@st.phenikaa-uni.edu.vn', 2023, 20010737, 'Tran Van Do', in_bag=",book1,book2")
        self.Member_DB.add_member('20010738@st.phenikaa-uni.edu.vn', 2023, 20010738, 'Le Quan Dung', in_bag=",book2")
        self.Member_DB.add_member('20010753@st.phenikaa-uni.edu.vn', 2023, 20010753, 'Nguyen Ngoc Tu', in_bag=",book3")
        self.Member_DB.add_member('20010735@st.phenikaa-uni.edu.vn', 2023, 20010735, 'Nguyen Duy Anh', in_bag=",book1,book2,book3")
